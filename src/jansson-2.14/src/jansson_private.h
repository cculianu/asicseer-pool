...
#define jsonp_free(ptr) jsonp_free_((void *)&(ptr))

char *jsonp_strndup(const char *str, size_t length) JANSSON_ATTRS((warn_unused_result));
char *jsonp_strdup(const char *str) JANSSON_ATTRS((warn_unused_result));
char *jsonp_strsteal(strbuffer_t *strbuff) JANSSON_ATTRS((warn_unused_result));
char *jsonp_eolstrsteal(strbuffer_t *strbuff) JANSSON_ATTRS((warn_unused_result));
